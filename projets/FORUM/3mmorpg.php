...
if(isset($_POST['submit']))
{
    ...
    $requete = $bdd->query("SELECT id_t FROM topics WHERE id_t = 4");
...
$requete = $bdd->query("SELECT titre FROM topics WHERE id_t = 4 ");
if($reponse = $requete->fetch())
{
  $titre= $reponse['titre'];
  echo "<h2>" .$titre. "</h2>";
...
<form action="#" method="post">
    ...
    <textarea class="subject" name="message" placeholder="Votre message..." style="height:100px"></textarea>
